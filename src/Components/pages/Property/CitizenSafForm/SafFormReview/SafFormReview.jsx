...
function SafFormReview(props) {
  ...
  return (
    <>
      <div
        className={` block p-4 mt-4 w-full md:py-4 md:pb-0 md:pt-0 rounded-lg  md:w-full mx-auto  overflow-x-auto md:px-20`}
      >
        <h1 className="px-2 font-semibold mt-0 text-center text-gray-700 font-serif py-2 text-xl mb-10">
          Review and submit your form details.
        </h1>
        <div className="mt-4 mx-auto">
          <div>
            <h1 className="px-1 font-semibold font-serif text-xs">
              <img src={folder} alt="pin" className="w-5 inline" /> Basic
              Details
            </h1>
              ...
              <div className="flex space-x-10 pl-4 ">
                <div className="flex-1 text-xs">
                  <div className="font-bold text-sm">
                    {props?.formReviewData?.basicDetails?.wardNo}
                  </div>
                  <div className="text-gray-500">Ward No.</div>
                </div>
                <div className="flex-1 text-xs">
                  <div className="font-semibold text-sm">
                    {props?.formReviewData?.basicDetails?.newWardNo}
                  </div>
                  <div className="text-gray-500">New Ward No</div>
                </div>
                <div className="flex-1 text-xs">
                  <div className="font-semibold text-sm">
                    {props?.formReviewData?.basicDetails?.ownerShiptype}
                  </div>
                  <div className="text-gray-500">Ownership Type</div>
                </div>
                <div className="flex-1 text-xs">
                  <div className="font-bold text-sm">
                    {props?.formReviewData?.basicDetails?.propertyType} BUILDING
                  </div>
          ...
          <h1 className="px-1 font-semibold font-serif text-xs mt-10">
            <img src={home} alt="pin" className="w-5 inline" /> Property Address
            & Details
          </h1>
          <div className="bg-white rounded-lg shadow-lg py-6">
            <div className="flex space-x-10 pl-4 ">
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.khataNo}
                </div>
                <div className="text-gray-500">Khata No.</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-semibold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.plotNo}
                </div>
                <div className="text-gray-500">Plot No</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-semibold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.village_mauja}
                </div>
                <div className="text-gray-500">Village/Mauja Name</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.plotArea}
                </div>
                <div className="text-gray-500">Area of Plot(decimal)</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.roadWidth}
                </div>
            ...
            <div className="flex space-x-10  pl-4 mt-4">
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.city}
                </div>
                <div className="text-gray-500">City</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-semibold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.district}
                </div>
                <div className="text-gray-500">District</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-semibold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.state}
                </div>
                <div className="text-gray-500">State</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.pin}
                </div>
                <div className="text-gray-500">Pin</div>
              </div>
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.propertyAddressDetails?.locality}
                </div>
            ...
            {props?.formReviewData?.propertyAddressDetails?.addressCheckbox !=
            true ? (
              <div className="pl-4 font-bold text-sm text-center">
              ...
              <div className="flex space-x-10  pl-4 mt-4">
                <div className="flex-1 text-xs">
                  <div className="font-bold text-sm">
                    {props?.formReviewData?.propertyAddressDetails?.c_city == ""
                      ? "N/a"
                      : props?.formReviewData?.propertyAddressDetails?.c_city}
                  </div>
                  <div className="text-gray-500">City</div>
                ...
                <div className="flex-1 text-xs">
                  <div className="font-semibold text-sm">
                    {props?.formReviewData?.propertyAddressDetails
                      ?.c_district == ""
                      ? "N/a"
                      : props?.formReviewData?.propertyAddressDetails
                          ?.c_district}
                ...
                <div className="flex-1 text-xs">
                  <div className="font-semibold text-sm">
                    {props?.formReviewData?.propertyAddressDetails?.c_state ==
                    ""
                      ? "N/a"
                      : props?.formReviewData?.propertyAddressDetails?.c_state}
                  </div>
                ...
                <div className="flex-1 text-xs">
                  <div className="font-bold text-sm">
                    {props?.formReviewData?.propertyAddressDetails?.c_pin == ""
                      ? "N/a"
                      : props?.formReviewData?.propertyAddressDetails?.c_pin}
                  </div>
                  <div className="text-gray-500">Pin</div>
          ...
          {/* electricity details */}
          <h1 className="px-1 font-semibold font-serif text-xs mt-6">
            {" "}
          ...
          <div className="bg-white rounded-lg shadow-lg py-6">
            <div className="flex space-x-10 pl-4 ">
              <div className="flex-1 text-xs">
                <div className="font-bold text-sm">
                  {props?.formReviewData?.electricityWaterDetails
                    ?.electricityKNo == ""
                    ? "N/a"
                    : props?.formReviewData?.electricityWaterDetails
                        ?.electricityKNo}
              ...
              <div className="flex-1 text-xs">
                <div className="font-semibold text-sm">
                  {props?.formReviewData?.electricityWaterDetails?.accNo == ""
                    ? "N/a"
                    : props?.formReviewData?.electricityWaterDetails?.accNo}
                </div>
              ...
              <div className="flex-1 text-xs">
                <div className="font-semibold text-sm">
                  {props?.formReviewData?.electricityWaterDetails?.bindBookNo ==
                  ""
                    ? "N/a"
                    : props?.formReviewData?.electricityWaterDetails
                        ?.bindBookNo}
                ...
                {props?.formReviewData?.ownerDetails?.map((owner, index) => (
                  <>
                    <tr className="bg-white shadow-lg border-b border-gray-200">
                      ...
                      <td className="px-2 py-2 text-sm text-left">
                        {owner.aadhar == "" || owner.aadhar == null
                          ? "N/A"
                          : owner.aadhar}
                      </td>
                      <td className="px-2 py-2 text-sm text-left">
                        {owner.pan == "" || owner.pan == null
                          ? "N/A"
                          : owner.pan}
                      </td>
                      <td className="px-2 py-2 text-sm text-left">
          ...
          <div className="mt-8">
            <h1 className="px-1 font-semibold font-serif text-xs">
              <img src={building} alt="building image" className="inline w-4" />{" "}
              Floor Details
            </h1>
                ...
                {props?.formReviewData?.floorDetails?.map((floor, index) => (
                  <>
                    <tr className="bg-white shadow-lg border-b border-gray-200">
                      ...
                      <td className="px-2 py-2 text-sm text-left">
                        {floor?.dateUpto == "" || floor?.dateUpto == null
                          ? "N/A"
                          : floor?.dateUpto}
                      </td>
                    </tr>
          ...
          <div className="mt-8">
            <h1 className="px-1 font-semibold font-serif text-xs">
              <img src={folder} alt="pin" className="w-5 inline" /> Additional
              Details
            </h1>
            <div className="bg-white rounded-lg shadow-lg py-6">
              <div className="flex space-x-10  pl-4 mt-4">
                {props?.zoneValue && (
                  <div className="flex-1 text-xs">
                    <div className="font-bold text-sm">
                      {props?.formReviewData?.additionalDetails?.zone}
                    </div>
                    <div className="text-gray-500">Zone</div>
                  </div>
                )}
                <div className="flex-1 text-xs">
                  <div className="font-bold text-sm">
                    {props?.formReviewData?.additionalDetails
                      ?.mobileTowerStatus == "0"
                      ? "No"
                      : "Yes"}
                  </div>
                ...
                <div className="flex-1 text-xs">
                  <div className="font-semibold text-sm">
                    {props?.formReviewData?.additionalDetails?.hoardingStatus ==
                    "0"
                      ? "No"
                      : "Yes"}
                  </div>
                ...
                {props?.zoneValue == false && (
                  <div className="flex-1 text-xs"></div>
                )}
              </div>
              <div className="flex space-x-10  pl-4 mt-4">
                {props?.zoneValue && <div className="flex-1 text-xs"></div>}
                <div className="flex-1 text-xs">
                  {props?.formReviewData?.additionalDetails
                    ?.mobileTowerStatus == "1" && (
                    <div className="flex-1 text-xs">
                ...
                <div className="flex-1 text-xs">
                  {props?.formReviewData?.additionalDetails?.hoardingStatus ==
                    ...
                    <div className="flex-1 text-xs">
                      <div className="font-bold text-sm">
                        {props?.formReviewData?.additionalDetails?.hoardingDate}
                      </div>
                ...
                <div className="flex-1 text-xs">
                  {props?.formReviewData?.additionalDetails?.petrolPumpStatus ==
                    "1" && (
                    <div className="flex-1 text-xs">
                      <div className="font-bold text-sm">
                        {
                ...
                <div className="flex-1 text-xs">
                  {props?.formReviewData?.additionalDetails
                    ...
                    <div className="flex-1 text-xs">
                      ...
                      <div className="text-gray-500">
                        Mobile Tower Installation Date
                      </div>
                    </div>
                  )}
                </div>
                <div className="flex-1 text-xs">
                  {props?.formReviewData?.additionalDetails?.hoardingStatus ==
                    ...
                    <div className="flex-1 text-xs">
                      ...
                      <div className="text-gray-500">
                        Hoarding Board Installation Date
                      </div>
                    </div>
                  )}
                </div>
          ...
          {taxDescriptionState && (
            <div className="">
              ...
              {props?.rulesetData?.data?.details?.RuleSet1 && (
                <div className="mt-8">
                  <div className="px-1 flex  font-serif underline">
                    <div className="bg-gray-800 w-7 h-7 rounded-full flex justify-center items-center inline mr-2 ml-3 shadow-lg border border-white text-white">
                      1
                    </div>{" "}
                    Tax Description of Annual Rental Value - As Per Old Rule
                    (Effect Upto <div className="font-semibold">31-03-2016</div>{" "}
                    )
                  </div>
                  {/* Tax description */}
                  <div
                    className={` block p-4 mt-2 w-full md:py-4 md:px-4 md:pb-0 md:pt-0 rounded-lg bg-gray-50 md:w-full mx-auto overflow-x-auto`}
                  >
                    <div>
                      <div>
                        <table className="min-w-full leading-normal mt-2">
                          ...
                          <tbody className="text-sm">
                            {props?.rulesetData?.data?.details?.RuleSet1?.floors?.map(
                              (data, index) => (
                                <tr className="bg-white shadow-lg border-b border-gray-200">
                                  <td className="px-2 py-2 text-sm text-left">
                                    {index + 1}
                                  ...
                                  <td className="px-2 py-2 text-sm text-left">
                                    <span className="bg-amber-200 px-2 py-1 rounded-lg shadow-lg border border-white">
                                      {data?.arv}
                                    </span>
                                  </td>
                                </tr>
                      ...
                      <div>
                        <h1 className="px-2 font-semibold mt-4 text-gray-600 text-xs">
                          Below taxes are calculated on quarterly basis(
                          Property Tax / 4 ).
                        </h1>
                        ...
                        <table className="min-w-full leading-normal mt-2">
                          ...
                          <tbody className="text-sm">
                            {props?.rulesetData?.data?.details?.RuleSet1?.totalQtrTaxes.map(
                              (data) => (
                                <tr className="bg-white shadow-lg border-b border-gray-200">
                                  <td className="px-2 py-2 text-sm text-left">
                                    1
                      ...
                      <div className="mt-10 bg-amber-100 pb-6">
                        {/* formula text */}
                        <h1 className="px-2 font-semibold mt-4 text-gray-600 text-xs bg-white">
                          Tax Description
                        </h1>
                        <div className="flex font-mono text-xs bg-amber-100 py-2 px-1 text-gray-900">
                          ...
                          <div className="flex-initial px-2 bg-gray-100 rounded-lg shadow-lg">
                            Builtup Area
                          </div>
                        ...
                        <div className="flex-initial px-3 text-xs">
                          (After calculating the A.R.V. the rebates are allowed
                          in following manner : -Holding older than 25 years (as
                          on 1967-68) - 10% Own occupation)
                        </div>
                        ...
                        <div className="flex font-mono text-xs bg-amber-100 px-1 mt-3">
                          <div
                            onClick={() => openModal("rental_rate1")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                        ...
                        <h1 className="px-4 font-semibold mt-8 text-gray-600 text-xs underline">
                          Usage Type tax %
                        </h1>
                        <div className="flex font-serif text-xs bg-amber-100 px-1 mt-2">
                          <div className="flex-initial px-2 text-white rounded-lg">
                            <span className="text-gray-900 px-2 py-2 rounded-lg">
                              {" "}
                              Residential -{" "}
              ...
              {props?.rulesetData?.data?.details?.RuleSet2 && (
                <div className="mt-16" id="scr">
                  <h1 className="px-1 flex  font-serif  underline">
                    <div className="bg-gray-800 w-7 h-7 rounded-full flex justify-center items-center inline mr-2 ml-3 shadow-lg border border-white text-white">
                      2
                    </div>
                    Tax Description Annual Rental Value - As ARV Rule (Effect
                    From 01-04-2016 to 31-03-2022)
                  </h1>
                  {/* Tax description */}
                  <div
                    className={` block p-4 mt-2 w-full md:py-4 md:px-4 md:pb-0 md:pt-0 rounded-lg bg-gray-50 md:w-full mx-auto overflow-x-auto`}
                    ...
                    <div>
                      <div>
                        <table className="min-w-full leading-normal mt-2">
                          ...
                          <tbody className="text-sm">
                            {props?.rulesetData?.data?.details?.RuleSet2?.floors?.map(
                              (data, index) => (
                                <tr className="bg-white shadow-lg border-b border-gray-200">
                                  <td className="px-2 py-2 text-sm text-left">
                                    {index + 1}
                      ...
                      <div>
                        ...
                        <table className="min-w-full leading-normal mt-2">
                          ...
                          <tbody className="text-sm">
                            {props?.rulesetData?.data?.details?.RuleSet2?.totalQtrTaxes.map(
                              (data) => (
                                <tr className="bg-white shadow-lg border-b border-gray-200">
                                  <td className="px-2 py-2 text-sm text-left">
                                    1
                      ...
                      <div className="mt-10 bg-amber-100 pb-6">
                        ...
                        <h1 className="px-4 font-semibold mt-4 text-gray-600 text-xs">
                          Rates
                        </h1>
                        <div className="flex font-mono text-xs bg-amber-100 px-1">
                          <div
                            onClick={() => openModal("usageFactor_rate2")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                          ...
                          <div
                            onClick={() => openModal("occupancyFactor_rate2")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                                ...
                                alt="icon-image"
                              />{" "}
                              View Occupancy Factor
                            </span>
                          </div>
                          <div
                            onClick={() => openModal("rental_rate2")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
              ...
              {/* tax 3 */}
              {props?.rulesetData?.data?.details?.RuleSet3 && (
                <div className="mt-16">
                  <h1 className="px-1 flex  font-serif underline">
                    <div className="bg-gray-800 w-7 h-7 rounded-full flex justify-center items-center inline mr-2 ml-3 shadow-lg border border-white text-white">
                      3
                    </div>
                    Tax Description of Capital Value - As Per Current Rule
                    ...
                    <div>
                      <div>
                        ...
                        <table className="min-w-full leading-normal mt-2">
                          ...
                          <tbody className="text-sm">
                            {props?.rulesetData?.data?.details?.RuleSet3?.floors?.map(
                              (data, index) => (
                                <tr className="bg-white shadow-lg border-b border-gray-200">
                                  <td className="px-2 py-2 text-sm text-left">
                                    {index + 1}
                      ...
                      <div>
                        ...
                        <table className="min-w-full leading-normal mt-2">
                          ...
                          <tbody className="text-sm">
                            {props?.rulesetData?.data?.details?.RuleSet3?.totalQtrTaxes.map(
                              (data) => (
                                <tr className="bg-white shadow-lg border-b border-gray-200">
                                  <td className="px-2 py-2 text-sm text-left">
                                    1
                      ...
                      <div className="mt-10 bg-amber-100 pb-6">
                        ...
                        <div className="flex font-mono text-xs bg-amber-100 px-1">
                          <div
                            onClick={() => openModal("circle_rate3")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                          ...
                          <div
                            onClick={() => openModal("occupancyFactor_rate3")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                          ...
                          <div
                            onClick={() => openModal("matrixFactor_rate3")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                                ...
                                alt="icon-image"
                              />{" "}
                              View Matrix Factor Rate
                            </span>
                          </div>

                          <div
                            onClick={() => openModal("calculationFactor_rate3")}
                            className="flex-initial px-2 text-white rounded-lg mt-4"
                          >
                            <span className="bg-gray-200 border border-white text-gray-900 px-2 py-2 shadow-lg rounded-lg cursor-pointer hover:bg-white">
                              <img
                        ...
                        <div className="flex font-serif text-xs bg-amber-100 px-1 mt-2">
                          ...
                          <div className="flex-initial px-2 text-white rounded-lg">
                            <span className="text-gray-900 px-2 py-2 rounded-lg">
                              {" "}
                              Commercial & greater than 25000 sqft -{" "}
                              <span className="font-mono text-sm font-semibold">
                                0.20%
                              </span>
                            </span>
          ...
          <div className="w-full flex mb-10 mt-4">
            <div className=" flex-1">
              <button
                onClick={() => props.backFun(7)}
                type="button"
                className="pl-4 pr-6 py-2 bg-gray-200 text-gray-800 font-medium text-xs leading-tight uppercase rounded shadow-lg hover:bg-sky-100 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0  active:shadow-lg transition duration-150 ease-in-out"
              >
                <TbEdit className="inline text-lg" /> Edit
              </button>
            </div>
            <div className="md:px-4 text-center">
              {props?.safType != "bo-edit" && (
                <button
                  ...
                  type="button"
                  className="cypress_review_tax_desciption_toggle w-full px-6 py-1 bg-gray-200 text-gray-800 font-medium text-xs leading-tight uppercase rounded shadow-lg hover:bg-amber-100 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0  active:shadow-lg transition duration-150 ease-in-out"
                >
            ...
            <div className="md:px-10 text-right flex-1">
              <button
                ...
                type="button"
                className="cypress_saf_submit px-6 py-2 bg-indigo-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-indigo-700 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-indigo-800 active:shadow-lg transition duration-150 ease-in-out"
              >
                {props?.safType == "bo-edit" ? "Save" : "Submit"}{" "}
                <MdOutlineUpload className="inline text-lg" />
              </button>
            </div>
          </div>
        </div>
      ...
      >
        <div className="relative rounded-xl p-6 border-2 border-gray-200 bg-white">
          <button type="button" onClick={closeModal}>
            <TiDelete className="absolute top-5 right-5 text-red-500 text-3xl hover:scale-125" />
          </button>
      ...
      >
        <OtpScreen
          allFormData={props?.formReviewData}
          submitFun={props.submitFun}
          closeOtpModaal={closeOtpModaal}
        />
      </Modal> */}
    </>
  );
