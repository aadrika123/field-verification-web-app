    ...
    <div className='border-2 border-blue-700 bg-blue-50 mb-4'>
                ...
                <div className='px-2 py-2'>
                    ...
                    {props?.utc && <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6'>{props?.tcData?.existingFloors[index]?.usage_type == '' ? 'N/A' : props?.tcData?.existingFloors[index]?.usage_type}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                    <span className=' col-span-6 font-semibold'>Agency TC</span>
                    <span className='col-span-6'>{props?.tcData?.existingFloors[index]?.occupancy_type == '' ? 'N/A' : props?.tcData?.existingFloors[index]?.occupancy_type}</span>
                </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.existingFloors[index]?.construction_type == '' ? 'N/A' : props?.tcData?.existingFloors[index]?.construction_type}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.existingFloors[index]?.builtup_area == '' ? 'N/A' : props?.tcData?.existingFloors[index]?.builtup_area}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
                            {data?.buildupAreaStatus == 'true' ? 'Correct' : 'Incorrect'}
                        </span>
                    </div>
                    <div className="grid grid-cols-12 text-sm">
                        <span className='col-span-6 font-semibold'>Verification</span>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.existingFloors[index]?.date_from == '' ? 'N/A' : props?.tcData?.existingFloors[index]?.date_from}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.existingFloors[index]?.date_upto == '' ? 'N/A' : props?.tcData?.existingFloors[index]?.date_upto}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
...

{
    ...
    <div className='border-2 border-blue-700 bg-blue-50 mb-4'>
                ...
                <span> {
                        ...
                        } <span className='text-xs'>(Added By Agency TC)</span>(Preview)</span>
                </h1>
                ...
                <div className='px-2 py-2'>
                    ...
                    {props?.utc && <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.newFloors[index]?.usage_type == '' ? 'N/A' : props?.tcData?.newFloors[index]?.usage_type}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                    <span className=' col-span-6 font-semibold'>Agency TC</span>
                    <span className='col-span-6'>{props?.tcData?.newFloors[index]?.occupancy_type == '' ? 'N/A' : props?.tcData?.newFloors[index]?.occupancy_type}</span>
                </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.newFloors[index]?.construction_type == '' ? 'N/A' : props?.tcData?.newFloors[index]?.construction_type}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.newFloors[index]?.builtup_area == '' ? 'N/A' : props?.tcData?.newFloors[index]?.builtup_area}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.newFloors[index]?.date_from == '' ? 'N/A' : props?.tcData?.newFloors[index]?.date_from}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className=' col-span-6 font-semibold'>Agency TC</span>
                        <span className='col-span-6'>{props?.tcData?.newFloors[index]?.date_upto == '' ? 'N/A' : props?.tcData?.newFloors[index]?.date_upto}</span>
                    </div>}
                    <div className="grid grid-cols-12 text-sm pb-2">
                        <span className='col-span-6 font-semibold'>Check</span>
                        <span className='col-span-6 flex gap-2'>
