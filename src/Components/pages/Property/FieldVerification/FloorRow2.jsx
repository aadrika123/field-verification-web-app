...
const FloorRow2 = (props) => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            useType: props?.preData?.useType,
            occupancyType: props?.preData?.occupancyType,
            constructionType: props?.preData?.constructionType,
            buildupArea: props?.preData?.buildupArea,
            dateFrom: props?.preData?.dateFrom,
            dateUpto: props?.preData?.dateUpto,
        },
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6 flex gap-2' onClick={handleStatus}>
                            ...
                            <input type="radio" name="useTypeStatus" required id="check1" checked={props?.preData?.useTypeStatus == 'true' ? true : null} value={true} />
                            <label htmlFor="check 1">Correct</label>
                            </span>
                            <span className='flex gap-1'>
                            <input type="radio" name="useTypeStatus" required id="check2" value={false} checked={props?.preData?.useTypeStatus == 'false' ? true : null} />
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6 flex gap-2' onClick={handleStatus}>
                            <span className='flex gap-1'>
                            <input type="radio" name="occupancyTypeStatus" required id="check1" checked={props?.preData?.occupancyTypeStatus == 'true' ? true : null} value={true} />
                            <label htmlFor="check 1">Correct</label>
                            </span>
                            <span className='flex gap-1'>
                            <input type="radio" name="occupancyTypeStatus" required id="check2" value={false} checked={props?.preData?.occupancyTypeStatus == 'false' ? true : null} />
                            <label htmlFor="check 2">Incorrect</label>
                            </span>
                        </span>
                    </div>
                    <div className="grid grid-cols-12 text-sm">
                        <span className='col-span-6 font-semibold'>Verification</span>
                        <span className='col-span-6'>
                            <select name='occupancyType' disabled={occupancyTypeStatus} value={occupancyTypeStatus ? props?.data?.occupancy_type_mstr_id : formik.values.occupancyType}  className='bg-white px-2 py-1 w-full rounded-sm shadow-sm border-[1px] border-gray-400'>
                                <option value="">--Select--</option>
                                {
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6 flex gap-2' onClick={handleStatus}>
                            <span className='flex gap-1'>
                            <input type="radio" name="constructionTypeStatus" required id="check1" checked={props?.preData?.constructionTypeStatus == 'true' ? true : null} value={true} />
                            <label htmlFor="check 1">Correct</label>
                            </span>
                            <span className='flex gap-1'>
                            <input type="radio" name="constructionTypeStatus" required id="check2" value={false} checked={props?.preData?.constructionTypeStatus == 'false' ? true : null} />
                            <label htmlFor="check 2">Incorrect</label>
                            </span>
                        </span>
                    </div>
                    <div className="grid grid-cols-12 text-sm">
                        <span className='col-span-6 font-semibold'>Verification</span>
                        <span className='col-span-6'>
                            <select name='constructionType' disabled={constructionTypeStatus} value={constructionTypeStatus ? props?.data?.const_type_mstr_id : formik.values.constructionType}  className='bg-white px-2 py-1 w-full rounded-sm shadow-sm border-[1px] border-gray-400'>
                                <option value="">--Select--</option>
                                {
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6 flex gap-2' onClick={handleStatus}>
                            <span className='flex gap-1'>
                            <input type="radio" name="buildupAreaStatus" required id="check1" checked={props?.preData?.buildupAreaStatus == 'true' ? true : null} value={true} />
                            <label htmlFor="check 1">Correct</label>
                            </span>
                            <span className='flex gap-1'>
                            <input type="radio" name="buildupAreaStatus" required id="check2" value={false} checked={props?.preData?.buildupAreaStatus == 'false' ? true : null} />
                            <label htmlFor="check 2">Incorrect</label>
                            </span>
                        </span>
                    </div>
            ...
            <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6 flex gap-2' onClick={handleStatus}>
                            <span className='flex gap-1'>
                            <input type="radio" name="dateFromStatus" required id="check1" checked={props?.preData?.dateFromStatus == 'true' ? true : null} value={true} />
                            <label htmlFor="check 1">Correct</label>
                            </span>
                            <span className='flex gap-1'>
                            <input type="radio" name="dateFromStatus" required id="check2" value={false} checked={props?.preData?.dateFromStatus == 'false' ? true : null} />
                            <label htmlFor="check 2">Incorrect</label>
                            </span>
                        </span>
                    </div>
                    <div className="grid grid-cols-12 text-sm">
                        <span className='col-span-6 font-semibold'>Verification</span>
                        <span className='col-span-6'>
                            <input type='date' name='dateFrom' disabled={dateFromStatus} value={dateFromStatus ? props?.data?.date_from : formik.values.dateFrom}  className='bg-white px-2 py-1 w-full rounded-sm shadow-sm border-[1px] border-gray-400' />
           ...
           <div className='bg-indigo-50 border-2 border-indigo-500 my-2 mx-1'>
                ...
                <div className='px-2 py-2'>
                    ...
                    <div className="grid grid-cols-12 text-sm pb-2">
                        ...
                        <span className='col-span-6 flex gap-2' onClick={handleStatus}>
                            <span className='flex gap-1'>
                            <input type="radio" name="dateUptoStatus" required id="check1" checked={props?.preData?.dateUptoStatus == 'true' ? true : null} value={true} />
                            <label htmlFor="check 1">Correct</label>
                            </span>
                            <span className='flex gap-1'>
                            <input type="radio" name="dateUptoStatus" required id="check2" value={false} checked={props?.preData?.dateUptoStatus == 'false' ? true : null} />
                            <label htmlFor="check 2">Incorrect</label>
                            </span>
                        </span>
                    </div>
