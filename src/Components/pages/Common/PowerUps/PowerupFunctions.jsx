...
//function to get custom before date from current date
 const getBeforeDate = (beforeYear, beforeMonth, beforeDay) => {
    let cDate = new Date()
...
//function to get custom after date from current date
 const getAfterDate = (afterYear, afterMonth, afterDay) => {
    let cDate = new Date()
...
// }
 ...
 const returnCapitalize = (currentValue) => {
    let capitalizeValue = currentValue.toUpperCase()
    return capitalizeValue
}
 const allowFloatInput = (currentValue, oldValue, max = null) => {
 ...
 const allowNumberCommaInput = (currentValue, oldValue, max = null) => {
    if (currentValue.length > max)  //stop if max value and return oldvalue
        return oldValue
 ...
 const allowCharacterInput = (currentValue, oldValue, max = null) => {
    if (currentValue.length > max)  //stop if max value and return oldvalue
        return oldValue
 ...
 const allowCharacterSpaceCommaInput = (currentValue, oldValue, max = null) => {
    if (currentValue.length > max)  //stop if max value and return oldvalue
        return oldValue
 ...
 const allowMailInput = (currentValue, oldValue, max = null) => {
    if (currentValue.length > max)  //stop if max value and return oldvalue
        return oldValue
 ...
 const allowCharacterNumberSpaceInput = (currentValue, oldValue, max = null) => {
    if (currentValue.length > max)  //stop if max value and return oldvalue
        return oldValue
 ...
 const allowCharacterNumberSpaceCommaInput = (currentValue, oldValue, max = null) => {
    if (currentValue.length > max)  //stop if max value and return oldvalue
        return oldValue
...
export {getCurrentDate,returnCapitalize,allowFloatInput,allowNumberInput,allowNumberCommaInput,allowCharacterInput,allowCharacterSpaceCommaInput,allowCharacterNumberInput,allowMailInput,allowCharacterNumberSpaceInput,allowCharacterNumberSpaceCommaInput}
